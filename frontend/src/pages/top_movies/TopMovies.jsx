...
const TopMovies = () => {
    ...
    const onClick = () => {
        getData("http://localhost:8000/api/movies/top_api");
    }
    ...
    const getData = async (uri) => {
        ...
        const response2 = await axios.get("http://localhost:8000/api/movies/movies-by-genre?genre=" + genre, { headers: headers });
